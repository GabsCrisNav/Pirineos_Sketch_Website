...
<div class="main-content" style = "flex-direction: row; display: flex">
        ...
        $count = mysqli_num_rows($sql);
            ...
            if($count>0)
            {
                ...
                while($row=mysqli_fetch_assoc($sql))
                {
                    ...
                    $id_ddt = $row['id_ddt'];
                    $name_ddt = $row['name_ddt'];
                    $title_ddt = $row['title_ddt'];
                    $description_ddt = $row['description_ddt'];
                    $image_name_ddt = $row['image_name_ddt'];
                      ...
                      <tr>
                        ...
                        <th>$name_ddt</th>
                        <th>$title_ddt</th>
                        <th>$description_ddt</th>
                        <th>$image_name_ddt</th>
                      <tr>
                        <td>
                        <form action='?id_ddt= $id_ddt' method='post'>
    ...
    <?php
           ...
           $url = SITEURL.'admin/manage-ddt.php';
            ...
            if(isset($_POST['submit'])){
              ...
              $query = "INSERT INTO  `derivadas_de_trigo`( `name_ddt`, `title_ddt`, `description_ddt`, `image_name_ddt`)  VALUES ('$nombre','$title','$description','$image_name')";
        ...
        //funciona
          if(isset($_POST['delete'])){
            ...
            $query = "DELETE FROM derivadas_de_trigo WHERE id_ddt=$id_ddt";
            ...
            if(isset($_POST['update']))
            {
                ...
                $query = "SELECT * FROM derivadas_de_trigo WHERE id_ddt=$id_ddt";
            ...
            <div class="wrapper" style = "margin: 0">
                    ...
                    <form action="" method="post">
                        ...
                        <tr>
                            <td>Nombre: </td>
                            <td>
                                <input type="text" name="nombre" value="<?php echo $name_ddt; ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Titulo: </td>
                            <td>
                                <input type="text" name="title" value="<?php echo $title_ddt; ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Description: </td>
                            <td>
                                <textarea name="description" cols="30" rows="5"><?php echo $description_ddt; ?></textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Selecciona la imagen: </td>
                        <td>
                                <input type="text" name="image_name" value="<?php echo $image_name_ddt; ?>">
                        </td>
                    </tr>
            ...
            if(isset($_POST['upha']))
                    {
                        ...
                        $query2 = "UPDATE `derivadas_de_trigo` SET `name_ddt`='$nombre',`title_ddt`='$title',`description_ddt`='$description',`image_name_ddt`='$image_name' WHERE id_ddt = $id_ddt";
